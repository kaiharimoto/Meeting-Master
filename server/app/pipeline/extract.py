...
SYSTEM_PROMPT = (
    ...
    "- answer: the answer that was given, concise but complete. Wrap the "
    "key phrase — the number, date, name, or committed outcome — in "
    "**double asterisks** (markdown bold); at most one or two short bold "
    "spans, no other markdown.\n"
