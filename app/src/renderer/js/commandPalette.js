...
function commands() {
  return [
    ...
    button('save-transcript-btn', 'Save transcript', 'file txt export timestamps'),
    button('read-transcript-btn', 'Read transcript full screen',
      'immersive big large font search timestamps'),
    button('copy-ai-prompt-btn', 'Copy AI prompt', 'claude chatgpt external paste'),
    button('save-ai-prompt-btn', 'Save AI prompt', 'file txt export claude phone'),
